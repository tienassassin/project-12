    ...
    public void Init(Stats baseStats, Stats nonEqmStats, Stats overallStats, DamageType dmgType)
    {
        ...
        switch (key)
        {
            ...
            case "intelligence":
                ...
                valueList.Add(txtStatValue.text);
                valueList.Add(Common.GetFloatString(DataManager.Instance.GetStatLimit(key), 1));
                break;
            case "speed":
        ...
        txtTitle.text = Common.GetTitleCaseString(DataManager.Instance.GetStatName(key));
    }
