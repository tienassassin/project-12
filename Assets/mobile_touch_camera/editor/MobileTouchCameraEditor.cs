...
namespace BitBenderGames {
  ...
  public class MobileTouchCameraEditor : CustomInspector {
    ...
    private Vector3 DrawSphereHandle(Vector3 point, float handleSize) {
      ...
      var fmh_82_44_638353146400689627 = Quaternion.identity; return Handles.FreeMoveHandle(point, handleSize, Vector3.one, Handles.SphereHandleCap);
#else
...
#if UNITY_5_6_OR_NEWER
      var fmh_91_56_638353146400715779 = Quaternion.identity; Vector3 pointNew = Handles.FreeMoveHandle(point, handleSize, Vector3.one, Handles.DotHandleCap);
#else
    ...
    public override void OnInspectorGUI() {
      ...
      DrawPropertyField("camOverzoomMargin", mobileTouchCamera.CamOverzoomMargin >= 0);
      var serializedOverdragMargin = serializedObject.FindProperty("camOverdragMargin");
      DrawPropertyField("camOverdragMargin", serializedOverdragMargin.floatValue >= 0);
